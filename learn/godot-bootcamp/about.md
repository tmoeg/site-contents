...
<div class="hero" style="height: 90vh;">
    <div class="hero__image" style="background-image: url(/assets/typing.gif);"></div>
    <div class="hero__layout">
        <div class="hero__text">
            <span class="hero__hint"><svg width="3.8em" height="1.2em">
            <mask id="svgmask1">
                <rect x="0" y="0" width="200" height="200" fill="#ffffff"></rect>
                <text x="0.2em" y="1em" font-size=".7rem" font-weight="700"  fill="#000000">Онлайн</text> 
            </mask>
            <rect x="0" y="0" width="3.8em" height="1.2em" fill="#eeeeee" rx=".2em" mask="url(#svgmask1)"></rect>
            </svg></span>

            <span class="hero__hint"><svg width="4.2em" height="1.2em">
            <mask id="svgmask2">
                <rect x="0" y="0" width="200" height="200" fill="#ffffff"></rect>
                <text x="0.2em" y="1em" font-size=".7rem" font-weight="700" fill="#000000">Все лето</text> 
            </mask>
            <rect x="0" y="0" width="4.2em" height="1.2em" fill="#eeeeee" rx=".2em" mask="url(#svgmask2)"></rect>
            </svg></span>

            <span class="hero__hint"><svg width="6.8em" height="1.2em">
            <mask id="svgmask3">
                <rect x="0" y="0" width="200" height="200" fill="#ffffff"></rect>
                <text x="0.2em" y="1em" font-size=".7rem" font-weight="700" fill="#000000">В своем темпе</text> 
            </mask>
            <rect x="0" y="0" width="6.8em" height="1.2em" fill="#eeeeee" rx=".2em" mask="url(#svgmask3)"></rect>
            </svg></span>
              
            <h1 class="hero__title">Бесплатный геймдев буткемп</h1>
            <p>Опытные участники прокачают в разработке игр на <b>Godot engine</b></p>
            <p>Уже разбираешься? Попробуй себя в помощи начинающим</p>
...
<div class="row-flex-container">
    <div class="row-flex-container__center_container">
        <img alt="Graph" src="/assets/godot-bootcamp-diagram.svg">
    </div>
...
<h3 class="lending-h2">КОЛЛЕКТИВНОЕ САМООБУЧЕНИЕ</h3>
...
<div class="capsule" style="margin-top: 50px; margin-bottom: 75px;">
    ...
    <div class="capsule__content" >
        ...
        Прокачаются до уровня самостоятельной разработки в годо. Участники самостоятельно в своем темпе будут изучать материалы и разрабатывать игры
...
<h2 class="lending-h2">Подробнее о форматах</h2>
